...
const IntegrationSection = () => {
    ...
    return (
        <div id='integration-section' className="mx-auto px-4 py-8 bg-gradient-to-b from-[#162a47] via-[#3362A6] to-[#162a47] text-white relative overflow-hidden min-h-[400px]">
