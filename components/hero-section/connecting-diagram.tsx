            ...
            >
                ...
                <motion.div variants={containerAnimation} className="flex justify-center gap-4">
                    {[
                        ...
                        >
                            <Image src={`/api/placeholder/52/52`} alt={`Avatar ${i + 1}`} width={52} height={52} className="w-full h-full object-cover" />
                        </motion.div>
                    ))}
                </motion.div>
            </motion.div>
            ...
            >
                ...
                <motion.div className="absolute right-0 top-1/2 -translate-y-1/2 flex flex-col gap-5">
                    {[
                        ...
                        >
                            <Image src="/api/placeholder/52/52" width={52} height={52} alt="Avatar" className="w-full h-full object-cover" />
                        </motion.div>
                    ))}
                </motion.div>
            </motion.div>
