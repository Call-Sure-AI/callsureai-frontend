...
import { PermissionModal } from "@/components/dashboard/permission-modal";
    ...
    return (
        <Suspense fallback={<div>Loading...</div>}>
            ...
            <div className="flex justify-center items-center w-full h-screen bg-slate-100">
                ...
                <PermissionModal showPermissionModal={showPermissionModal} setShowPermissionModal={setShowPermissionModal} setMicrophonePermission={setMicrophonePermission} requestMicrophonePermission={requestMicrophonePermission} />
            </div>
        </Suspense>
    );
};